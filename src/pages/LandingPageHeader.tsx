  ...
  return (
    <Popover className="relative bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-white rounded-none p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-400">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "group bg-white rounded-none inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
                    )}
                  >
                    <span>Services</span>
                    <ChevronDownIcon
                        ...
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                          {solutions.map((item) => (
                            <Link
                              key={item.name}
                              to={item.to}
                              className="-m-3 p-3 flex items-start rounded-none hover:bg-gray-50"
                            >
                              <item.icon
                        ...
                        <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                          {callsToAction.map((item) => (
                            <div key={item.name} className="flow-root">
                              <Link
                                to={item.to}
                                className="-m-3 p-3 flex items-center rounded-none text-base font-medium text-gray-900 hover:bg-gray-100"
                              >
                                <item.icon
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <SunIcon className="w-5 h-5 text-gray-500 mr-3 transition duration-150 rounded-full hoverLbg-gray-300"/>
            <Link
              to="#"
              className="focus:ring-offset-2 focus:ring-2 focus:ring-blue-400 whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"
            >
              Create a project
            </Link>
            <Link
      ...
      >
        ...
        >
          <div className="rounded-none shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
